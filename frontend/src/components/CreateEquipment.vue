      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="mb-4 relative">
          ...
          <input type="text" id="tags" v-model="tags"
            placeholder="Seperate tag names by a comma e.g. first,second,third" @input="validateTags" required :class="['mt-1 block w-full border rounded-md p-2 focus:outline-none',
...
6.Late Returns.
    " v-model="terms" @input="validateTerms"
          ...
          <div v-for="(spec, index) in specifications" :key="index" class="mb-4">
            <div class="flex space-x-4">
              ...
              <div class="w-1/2">
                ...
                <input type="text" v-model="spec.key" id="key" placeholder="Enter a spec"
              ...
              <div class="w-1/2">
                ...
                <input type="text" v-model="spec.value" id="value" placeholder="Enter value"
                  class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:border-[#1c1c1c]" />
              </div>
        ...
        <div class="mb-4 relative">
          ...
          <select id="country" v-model="country" @input="validateCountry" required :class="[
            'mt-1 block w-full border rounded-md p-2 focus:outline-none',
...
const handleError = (error) => {
  if (error.response) {
    showNotification('Error Listing Item', 'Error posting item', 'error');
  } else if (error.request) {
    showNotification('Error Listing Item', 'Check Your Network Connection.', 'error');
  } else {
    showNotification('Error Listing Item', 'Error setting up the request.', 'error');
  }
};
