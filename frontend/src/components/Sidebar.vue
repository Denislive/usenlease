              ...
              <div class="flex items-center">
                ...
                <div class="image-container">
                  <img
                    ...
                    loading="lazy"
                    @error="(e) => e.target.src = '/images/category-placeholder.svg'"
                  >
                </div>
                ...
                >
                  ...
                  >
                    <div class="flex items-center">
                      ...
                      <div class="image-container">
                        <img
                          :src="subcategory.image || '/images/subcategory-placeholder.svg'"
                          :alt="`${subcategory.name} subcategory`"
                          class="subcategory-image"
                          loading="lazy"
                          @error="(e) => e.target.src = '/images/subcategory-placeholder.svg'"
                        >
                      </div>
...
.category-link {
  @apply flex items-center p-2 bg-white rounded-lg transition-all duration-200 
         text-gray-800 hover:bg-yellow-50 hover:shadow-md 
         focus:outline-none focus:ring-2 focus:ring-yellow-400;
}

.subcategories-list {
  @apply list-none pl-6 mt-1 space-y-1 max-h-0 overflow-hidden 
...
.subcategory-link {
  @apply flex items-center p-2 bg-gray-50 rounded-lg transition-all duration-200 
         text-gray-700 hover:bg-yellow-100 hover:translate-x-1
