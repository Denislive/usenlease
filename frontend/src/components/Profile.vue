<template>
  <div class="grid grid-cols-12 gap-8 md:px-32 py-4">
    <!-- Sidebar -->
    <div
      class="col-span-12 lg:col-span-3 bg-white p-4 rounded-lg hidden lg:block shadow-md"
    >
    ...
    <div
      v-if="showSidebar"
      class="col-span-12 lg:col-span-3 bg-white p-4 rounded-lg shadow-md md:block lg:hidden"
    >
      <div class="flex items-center space-x-4 mb-6">
        <i class="bi bi-person text-black text-2xl"></i>
        <span class="text-lg font-medium">
      ...
      <button
        @click="handleLogout"
        class="w-full px-4 py-2 text-white bg-red-500 hover:text-[#1c1c1c] rounded"
      >
        Logout
      </button>
      <hr class="my-4" />
    ...
    <!-- Main Content Area -->
    <div
      class="col-span-12 md:col-span-8 lg:col-span-9 bg-white p-6 rounded-lg shadow-md"
    >
      <div v-for="section in sections" :key="section.name" class="space-y-6">
        <div v-show="activeSection === section.name" class="section-content">
          <h3
            class="text-3xl font-semibold text-gray-800 mb-6 border-b border-gray-300 pb-3"
          >
            {{ section.label }}
          </h3>
          ...
          <div
            ...
            class="bg-white rounded-lg shadow-lg p-6 space-y-8"
          >
            <!-- Back Button -->
            <button
              @click="closeSidebar"
            ...
            <div class="flex items-center justify-center space-x-6">
              ...
              <div>
                <label
                  for="profile-pic"
                  class="block text-sm text-[#ffc107] font-semibold cursor-pointer"
                >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <p class="flex items-center text-gray-700">
                ...
                <span
                  ><strong>Full Name:</strong> {{ authStore.user?.first_name }}
              ...
              <p class="flex items-center text-gray-700">
                ...
                <span>
                  ...
                  <button
                    @click="phoneModalVisible = !phoneModalVisible"
            ...
            <div class="flex justify-start">
              <button
                @click="addressModalVisible = !addressModalVisible"
            ...
            <div v-if="store.userEquipments.length > 0">
              <div class="container mx-auto p-4">
                ...
                >
                  ...
                  <div
                    v-for="equipment in store.userEquipments"
                    :key="equipment.id"
            ...
            <div class="bg-white rounded-lg p-6 w-1/2">
              ...
              <form @submit.prevent="updateEquipment">
                ...
                <div class="mb-4">
                  ...
                  >
                  <input
                    v-model="editedEquipment.hourly_rate"
                    type="float"
                    id="hourly_rate"
                    class="w-full p-2 border rounded mt-1"
                    required
                ...
                <div class="mb-4 relative">
                  ...
                  <input
                    type="number"
                    min="1"
                    placeholder="Available items for renting out"
                    id="availableItems"
                    v-model.number="editedEquipment.available_quantity"
                    class="w-full p-2 border rounded mt-1"
                  />
                </div>
                ...
                <div class="mb-4">
                  ...
                  >
                  <select
                    v-model="editedEquipment.is_available"
                    id="is_available"
                    class="w-full p-2 border rounded mt-1"
                  >
                ...
                <div class="flex justify-end space-x-2">
                  ...
                  <button
                    type="submit"
                    class="px-4 py-2 bg-[#1c1c1c] text-[#ffc107] rounded"
                  >
                    Update
                  </button>
                </div>
          ...
          <div
            v-if="
              activeSection === 'my-orders' && authStore.user?.role === 'lessee'
            "
          >
            <button
              @click="closeSidebar"
            ...
            >
              <div class="bg-white rounded-lg shadow-lg w-96 p-6">
                ...
                <div class="flex justify-end">
                  <button
                    @click="performAction(orderToDelete.id, 'delete')"
                    class="px-4 py-2 bg-red-500 text-white rounded-md shadow-sm hover:bg-red-600"
                  >
                    Yes, Delete
                  </button>
          ...
          <div
            ...
            class="lg:px-4 py-2 min-h-screen flex flex-col lg:flex-row"
          >
            <!-- Chat List -->
            <div
              v-if="!activeChat"
              class="w-full lg:w-3/3 bg-white shadow-lg rounded-lg overflow-hidden mb-4 lg:mb-0"
            >
              <div
                class="border-b px-4 py-4 bg-[#ffc107] text-gray-800 font-bold text-lg flex items-center"
              >
                <button
                  @click="closeSidebar"
            ...
            <div
              v-if="activeChat"
              class="w-full lg:h-2/3 lg:w-3/3 bg-white shadow-lg rounded-lg flex flex-col"
            >
              <!-- Header -->
              <div
                class="border-b px-4 py-3 bg-[#ffc107] text-gray-800 font-bold flex items-center"
              >
                <button
              ...
              <!-- Chat Content -->
              <div
                class="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50 h-60 md:h-80 lg:h-auto"
              >
                <div
          ...
          >
            ...
            >
              <i
                class="pi pi-arrow-circle-left text-2xl text-[#1c1c1c] mr-2"
              ></i>
              Back
            </button>
            ...
            <div class="mt-6">
              ...
              <div
                v-if="loading"
                class="flex items-center justify-center text-gray-500 space-x-2 animate-pulse"
              >
              ...
              <div v-else>
                <!-- Lessor Report -->
                <div
                  v-if="authStore.user?.role === 'lessor'"
                  class="bg-gradient-to-br bg-[#ffc107] rounded-lg shadow-md p-6 border-l-4 border-[#1c1c1c]"
                >
                  <h2
                    class="text-2xl font-bold text-gray-800 mb-6 flex items-center space-x-3"
                  >
                  ...
                  <ul class="space-y-4">
                    ...
                    >
                      <i
                        class="pi pi-shopping-cart text-[#1c1c1c] text-2xl"
                      ></i>
                ...
                <!-- Lessee Report -->
                <div
                  v-else-if="authStore.user?.role === 'lessee'"
                  class="bg-gradient-to-br bg-[#ffc107] rounded-lg shadow-md p-6 border-l-4 border-[#1c1c1c]"
                >
                  <h2
                    class="text-2xl font-bold text-gray-800 mb-6 flex items-center space-x-3"
                ...
                >
                  ...
                  <span class="text-lg font-semibold"
                    >Unauthorized access or role not recognized.</span
                  >
                </div>
              </div>
            </div>
  ...
  >
    <div class="bg-white p-8 rounded-lg shadow-lg w-full sm:w-96">
      ...
      <div class="mb-4">
        ...
        >
        <input
          v-model="user.user_address.full_name"
          id="full_name"
          type="text"
      ...
      <div class="mb-4">
        <label for="street_address" class="block text-sm font-medium"
          >Street Address</label
        >
        <input
          v-model="user.user_address.street_address"
          id="street_address"
          type="text"
          class="mt-1 p-2 border border-gray-300 rounded-md w-full"
      ...
      <div class="mb-4">
        <label for="street_address2" class="block text-sm font-medium"
          >Street Address Line 2</label
        >
        <input
          v-model="user.user_address.street_address2"
          id="street_address2"
          type="text"
          class="mt-1 p-2 border border-gray-300 rounded-md w-full"
      ...
      <div class="mb-4">
        ...
        <input
          v-model="user.user_address.country"
          id="country"
          type="text"
          class="mt-1 p-2 border border-gray-300 rounded-md w-full"
      ...
      <div class="flex justify-between">
        <button
          ...
          class="px-4 py-2 bg-gray-300 text-white rounded-md"
        >
          Cancel
        </button>
        <button
          @click="updateAddress"
          class="px-4 py-2 bg-[#1c1c1c] text-[#ffc107] rounded-md"
        >
          <i class="bi bi-pencil-square"></i>
