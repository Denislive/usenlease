  ...
  <div class="bg-[#1c1c1c] p-1 sticky top-0 z-50">
    <div class="w-12/12 md:w-6/6 lg:w-6/6 xl:w-6/6 mx-auto px-2">
      ...
      <header class="text-white flex justify-between items-center">
        ...
        <RouterLink 
          :to="{ name: 'home' }" 
          class="flex items-center focus:outline-none rounded"
          aria-label="Home"
        >
          <img 
        ...
        <div v-if="authStore.isAuthenticated" class="flex items-center space-x-4">
          ...
          <div v-if="authStore.user.role === 'lessor'" class="relative">
            <RouterLink 
              to="/profile?section=my-equipments" 
            ...
            >
              ...
              <span
                v-if="store.userEquipments.length > 0"
          ...
          <div 
            ...
            @mouseenter="showDropdownWithDelay(true)"
...
/>
  ...
  <nav 
    class="fixed bottom-0 left-0 right-0 bg-[#1c1c1c] text-white p-2 shadow-lg md:hidden z-50"
  ...
  >
    <div class="flex justify-around items-center">
      <div class="text-center">
        <RouterLink 
          to="/" 
          class="flex flex-col items-center p-2 focus:outline-none focus:text-[#ffc107]"
          aria-label="Home"
        >
...
.router-link-active i, .router-link-active small {
  @apply text-[#ffc107];
}
</style>