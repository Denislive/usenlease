      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
        ...
        <div class="group">
          ...
          <ul class="space-y-3 pl-3">
            ...
            <li><RouterLink to="/new-profile/orders" class="bullet-link">My Orders</RouterLink></li>
            <li><RouterLink to="/new-profile/items" class="bullet-link">My Items</RouterLink></li>
          </ul>
        </div>
